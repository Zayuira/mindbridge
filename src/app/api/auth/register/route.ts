...
export async function POST(req: Request) {
  try {
    ...
    await Promise.all([
      sendEmail({
        to: email,
        subject: "Mind Bridge - И-мэйл баталгаажуулах код",
        body: `<h1>Сайн байна уу?</h1><p>Таны баталгаажуулах код: <b>${emailCode.code}</b></p><p>Энэ код 10 минутын дараа хүчингүй болно.</p>`,
      }),
      sendSMS({
        to: phone,
